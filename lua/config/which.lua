...
wk.register({
  ["<Tab>"] = {"<cmd>e#<cr>", "Switch to previously opened buffer"},
    f = {
      name = "Find",
        d = {"<cmd>lua require('config.alexis').search_dotfiles()<cr>", "Find ~/dotfiles"},
        b = {"<cmd>lua require'telescope.builtin'.buffers({ sort_mru = true, ignore_current_buffer = true })<cr>","Find Buffer"},
        f = {"<cmd>Telescope find_files<cr>","Find File"},
--        f = {"<cmd>lua require'telescope.builtin'.find_files({ find_command = {'fd', '--hidden', '--type', 'file', '--follow'}})<cr>"},
        t = {"<cmd>lua require('config.alexis').search_tuto()<cr>", "Find ~/Tuto"},
    },
    o = {
      name = "Open",
        ...
        s = {"<cmd>SidebarNvimFocus<CR>", "Sidebar Open"},
    },
    b = {
      name = "Buffers",
        a = {"<cmd>BufferLineCloseLeft<cr><cmd>BufferLineCloseRight<cr>","Close all but the current buffer"},
        d = {"<cmd>Bdelete!<CR>", "Close Buffer"},
        f = {"<cmd>lua require('config.alexis').curr_buf()<cr>", "fzf current buffer"},
